    ...
    <div>
        ...
        <div v-else class="card">
            <div class="card-body text-center">
                ...
                <div class="my-4 h5">
                    Secrets can be used in deployments by defining them as
                    inputs in the
