        ...
        <PlatzCollection :items="allPermissions">
            <template #item="scope">
                <PlatzItemWithActions>
                    <template #contents>
                        <div
                            class="mt-2 mb-1 d-flex flex-row align-items-center"
                        >
                            <PlatzUser
                                :id="scope.item.user_id"
                                :showName="true"
                            />
                            ...
                            <a
                                ...
                                @click="
                                    removeUserPermission &&
                                        removeUserPermission.open(scope.item)
                                "
                            >
                ...
                <div>
                    <div>
                        <button
                            ...
                            @click="
                                addUserPermission && addUserPermission.open()
                            "
                        >
                    ...
                    <div class="my-3 text-body-secondary text-start">
                        ...
                        Users listed here can see the env and everything in it
                        (deployments and custom resources). Admin users can
                        perform any operation and control permissions for all
                        other users.
                    </div>
                </div>
            </template>
            ...
            <template #empty-action>
                <div class="my-2">
                    There are no user permissions defined for this env, let's
