        ...
        <ul class="dropdown-menu" aria-labelledby="actionsDropdown">
            <template v-if="isMaintainer && filteredActions.length > 0">
                <li v-for="action in filteredActions" :key="action.id">
                    <a
                        ...
                        @click="
                            invokeAction &&
                                invokeAction.open(deployment, action)
                        "
                    >
                        <FaIcon
            ...
            <li v-if="isMaintainer">
                <a
                    class="dropdown-item"
                    @click="
                        editDeployment && editDeployment.openForEdit(deployment)
                    "
                >
            ...
            <li v-if="isMaintainer">
                <a
                    ...
                    @click="
                        editDeployment &&
                            editDeployment.openForCloneFrom(deployment)
                    "
                >
                    <FaIcon icon="edit" fixed-width />
            ...
            <template v-if="isOwner">
                ...
                <li v-if="!deployment.enabled">
                    <a
                        ...
                        @click="
                            enableDeployment &&
                                enableDeployment.open(deployment)
                        "
                    >
                ...
                <li v-if="deployment.enabled">
                    <a
                        ...
                        @click="
                            disableDeployment &&
                                disableDeployment.open(deployment)
                        "
                    >
                ...
                <li>
                    <a
                        ...
                        @click="
                            deleteDeployment &&
                                deleteDeployment.open(deployment.id)
                        "
                    >
