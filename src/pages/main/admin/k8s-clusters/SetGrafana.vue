<template>
    ...
    >
        ...
        <div class="mb-3 form-floating">
            ...
            <div class="form-text">
                Provide a full URL to the Grafana explore view, that would work
                for users outside the cluster, including http:// or https://
                (e.g. https://my.grafana.instance/explore)
            </div>
        </div>
