<template>
    ...
    >
        ...
        <div class="mb-2">
            ...
            If an ingress class is set, it's also injected to the deployment
            chart values when installing.
        </div>

        <div class="mb-2">
            Ingress TLS secret name turns on TLS for the ingress. Note that
            Platz doesn't check if the secret exists: This allows for using both
            a wildcard certificate replicated to all namespaces by services such
            as Reflector, or having a certificate created in the chart itself.
        </div>
        ...
        <div class="mb-3 form-floating">
            <input
                ...
                :disabled="working"
            />
            <label for="ingress_domain" class="form-label"
                >Ingress Domain</label
            >
            <div class="form-text">
        ...
        <div class="mb-3 form-floating">
            ...
            <div class="form-text">
                An ingress class might not be required if the cluster has a
