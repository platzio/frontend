<template>
    ...
    >
        ...
        <div class="mb-2">
            When a pattern successfully matches a Helm tag, the following named
            groups are used:
        </div>
        <ul>
        ...
        <div class="mb-2">
            It's recommended to wrap the pattern in <code>^</code> and
            <code>$</code>, but this is not mandatory in case this messes with
            parsing somehow.
        </div>
        <div class="my-3">
            <input
