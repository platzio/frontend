...
function isChartFeaturesV1Beta1(
  ...
  return (features as HelmChartFeaturesV1Beta1).apiVersion === "platz.io/v1beta1";
}
...
export function chartFeatures(chart?: HelmChart): HelmChartFeaturesV1Beta2Spec | undefined {
  ...
  const spec = isChartFeaturesV1Beta1(chart.features) ? chart.features.spec : chart.features;
  return {
    ingress: {
